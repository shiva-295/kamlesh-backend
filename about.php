<?php include "phpclass/function.php"?>
<!DOCTYPE html>
<html lang="zxx">
	<head>
    ...
    <body class="blue-skin">
        ...
        <div id="main-wrapper">
			...
			<!-- ============================ Page Title Start================================== -->
			<div class="hero-banner full bg-cover side-effect" style="background:white url(https://png.pngtree.com/png-clipart/20240321/original/pngtree-young-happy-pretty-smiling-professional-business-working-at-laptop-confident-positive-png-image_14649177.png)no-repeat;" data-overlay="2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-10">
							
							<h2 class="ipt-title mb-3">Creating the best commerce platform on the market</h2>
							<p class="text-light mb-4">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
							<div class="_ebl_link"><a href="#" class="btn _loonking_job">Get Started Now</a></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<img src="https://static.vecteezy.com/system/resources/previews/024/558/262/non_2x/businessman-isolated-illustration-ai-generative-free-png.png" alt="" class="img-fluid">
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="about-captione">
								...
								<a href="#" class="btn dark-2 btn-rounded">Learn More</a>
							</div>
						</div>
					...
					<div class="row justify-content-center">
						<div class="col-lg-7 col-md-9">
							<div class="sec-heading">
								<h2>Power Success For <span class="theme-cl-2">Brand</span></h2>
